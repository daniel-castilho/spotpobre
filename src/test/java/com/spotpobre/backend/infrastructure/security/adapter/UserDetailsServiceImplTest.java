...
class UserDetailsServiceImplTest {
    ...
    void shouldMapDomainUserToSpringUserDetails() {
        ...
        when(getUserDetailsUseCase.loadUserByUsername(email)).thenReturn(Optional.of(domainUser));
    ...
    @Test
    void shouldThrowUsernameNotFoundExceptionWhenUserAbsent() {
        // Given
        String email = "notfound@example.com";
        when(getUserDetailsUseCase.loadUserByUsername(email)).thenReturn(Optional.empty());
