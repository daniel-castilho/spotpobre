...
class UserDocumentTest {
    ...
    private UserDocument sample() {
        return UserDocument.builder()
                .id("u-1").password("pw")
                .emailVerifiedAt(java.time.Instant.parse("2026-08-23T12:00:00Z"))
                .build();
    }

    @Test
    void equals_reflexive_symmetric_null_and_differentType() {
        UserDocument a = sample();
        assertEquals(a, a);
    ...
    void equals_emptyInstances_areEqual_andToStringToleratesNulls() {
        UserDocument empty1 = new UserDocument();
        UserDocument empty2 = new UserDocument();
