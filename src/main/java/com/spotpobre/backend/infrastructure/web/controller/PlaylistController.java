...
public class PlaylistController {
    ...
    @PostMapping
    public ResponseEntity<PlaylistResponse> createPlaylist(@RequestBody @Valid final CreatePlaylistRequest request) {
        // TODO: Get ownerId from security context
        final UserId ownerId = UserId.generate();
